...
> ✅ **Источник схемы.** Все **30 эндпоинтов** провалидированы реальными API-вызовами на Basic-плане (2026-04-28). Полный pole-by-полю reference c top-level + nested keys для каждого эндпоинта — в **[_responses/instagram-looter2.md](_responses/instagram-looter2.md)**.
>
> Провайдер не заполнил Example Responses в Playground для этого API — поэтому сверяйся либо с reference-файлом, либо делай свой запрос на Basic ($0).
