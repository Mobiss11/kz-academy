...
> ✅ **Источник схемы.** Карточка собрана из RapidAPI Playground (params + Example Responses обоих эндпоинтов). Тарифы и формат 401 ошибки — verified живым вызовом. JSON-примеры ниже — реальные имена полей. Compact reference — в **[_responses/telegram-channel.md](_responses/telegram-channel.md)**.
>
